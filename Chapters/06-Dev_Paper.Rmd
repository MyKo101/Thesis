...
Further research would be needed to establish the efficacy of the use of such a model in clinical practice [@moons-prognosis-2009-1] by comparing it to standard care and establishing whether the use of our model improves patient outcomes, however we have clearly demonstrated the *effectiveness* of our model.
