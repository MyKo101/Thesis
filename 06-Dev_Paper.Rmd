...
```{r Hazard-Ratios, echo=FALSE, results='asis', message = FALSE, warning = FALSE, error=FALSE, tidy = FALSE}
paste0(.wd,"data/Dev_Paper_Hazard_Ratios.csv") %>%
  ...
  stardard_format_table(numeric.cols = 2:4,
                        widths=c(1.64,5,5,5))  
add_flextable_caption("Hazard-Ratios","Hazard Ratios for the Three-State Model")
