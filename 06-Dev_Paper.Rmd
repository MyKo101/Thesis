...
paste0(.wd,"data/Dev_Paper_Categorical_Demographics.csv") %>%
  ...
  to_kable(caption="Population demographics for the categorical variables presented as number (percent)",numeric_cols=c(2,3),row_names="Category",group_col="Variable")
...
paste0(.wd,"data/Dev_Paper_Event_Median.csv") %>%
  ...
  to_kable(caption="Event times for the two populations presented as Number of Events = Median (Inter-Quartile Range) [Min, Max]",
           align="crr",numeric_cols=2:3) %>%
  pack_rows(index=c("Two-State Model"=1,"Three-State Model"=3,"Five-State Model"=6))
...
```{r Example-Predictions-trend, out.width="90%", fig.cap="Results of Example Patients", echo=F, fig.hold="hold"}
